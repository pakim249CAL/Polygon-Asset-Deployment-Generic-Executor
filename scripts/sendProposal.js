...
async function main() {
  ...
  const encodedArgumentsGHST = ethers.utils.defaultAbiCoder.encode([
      'address', //token
      'address', //aToken
  ...
  proposalActions.calldatas.push(encodedArgumentsGHST);
  proposalActions.withDelegatecalls.push(true);


  const encodedArgumentsBAL = ethers.utils.defaultAbiCoder.encode([
    'address', //token
    'address', //aToken
    'address', //stableDebtToken
    'address', //variableDebtToken
  ...
  proposalActions.values.push(ethers.BigNumber.from('0'));
  proposalActions.signatures.push('execute(address,address,address,address,address,uint256,uint256,uint256,uint256,uint8,bool,bool,bool)');
  proposalActions.calldatas.push(encodedArgumentsBAL);
  proposalActions.withDelegatecalls.push(true);

  const encodedArgumentsDPI = ethers.utils.defaultAbiCoder.encode([
    'address', //token
    'address', //aToken
    'address', //stableDebtToken
    'address', //variableDebtToken
  ...
  proposalActions.values.push(ethers.BigNumber.from('0'));
  proposalActions.signatures.push('execute(address,address,address,address,address,uint256,uint256,uint256,uint256,uint8,bool,bool,bool)');
  proposalActions.calldatas.push(encodedArgumentsDPI);
  proposalActions.withDelegatecalls.push(true);

  const encodedArgumentsCRV = ethers.utils.defaultAbiCoder.encode([
    'address', //token
    'address', //aToken
    'address', //stableDebtToken
    'address', //variableDebtToken
  ...
  proposalActions.values.push(ethers.BigNumber.from('0'));
  proposalActions.signatures.push('execute(address,address,address,address,address,uint256,uint256,uint256,uint256,uint8,bool,bool,bool)');
  proposalActions.calldatas.push(encodedArgumentsCRV);
  proposalActions.withDelegatecalls.push(true);

  const encodedArgumentsSUSHI = ethers.utils.defaultAbiCoder.encode([
    'address', //token
    'address', //aToken
    'address', //stableDebtToken
    'address', //variableDebtToken
  ...
  proposalActions.values.push(ethers.BigNumber.from('0'));
  proposalActions.signatures.push('execute(address,address,address,address,address,uint256,uint256,uint256,uint256,uint8,bool,bool,bool)');
  proposalActions.calldatas.push(encodedArgumentsSUSHI);
  proposalActions.withDelegatecalls.push(true);

  const encodedArgumentsLINK = ethers.utils.defaultAbiCoder.encode([
    'address', //token
    'address', //aToken
    'address', //stableDebtToken
    'address', //variableDebtToken
  ...
  proposalActions.values.push(ethers.BigNumber.from('0'));
  proposalActions.signatures.push('execute(address,address,address,address,address,uint256,uint256,uint256,uint256,uint8,bool,bool,bool)');
  proposalActions.calldatas.push(encodedArgumentsLINK);
  proposalActions.withDelegatecalls.push(true);
  ...
  const tx = await aaveGovernanceV2.create(
